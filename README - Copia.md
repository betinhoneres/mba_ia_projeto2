...
1. **Role Prompting (Definição de persona)**
   * *Como foi aplicado*: O modelo foi instruído explicitamente com a persona: `"Você é um Product Manager e Business Analyst sênior, especialista em metodologias ágeis e escrita de requisitos técnicos de alta qualidade."`
